...
dataset_root = data_path+'rcnn-pretrain/'
...
datasets = [
   dict(
    ...
    dict(
        train=dict(
            type=dataset_type,
            ann_file=dataset_root + 'lspet/' + 'train.pkl',
            img_prefix=dataset_root + 'lspet/' + 'images/',
            sample_weight=0.3,
            ignore_smpl=IGNORE_PSEUDO_GT,
            ignore_3d=IGNORE_PSEUDO_GT,
            **common_train_cfg
...
# optimizer
optimizer = dict(type=RAdam, lr=2e-4, weight_decay=0.0001)
